...
function RandomPasswordGenerator() {
  ...
  return (
    <div className=' h-auto max-w-[40rem] flex flex-col justify-center items-center p-4 mt-10 rounded-lg shadow-[0px_0px_15px_5px_rgba(0,0,0,0.2)] dark:shadow-[0px_0px_10px_5px_rgba(255,255,255,0.1)]'>

        <p className='font-semibold text-lg'>Random Password Generator</p>
          
        <div className='flex flex-row p-2 mt-4'>
            <input value={password} readOnly className='dark:bg-gray-700 w-[300px] rounded-md p-2 outline-none shadow-[0px_0px_10px_5px_rgba(0,0,0,0.1)] dark:shadow-[0px_0px_10px_5px_rgba(255,255,255,0.1)]' type='text' placeholder='Password'/>
            <button onClick={handleCopyButton} className='w-[100px] ml-4 rounded-md text-white pl-2 pr-2 font-semibold bg-blue-600 hover:bg-blue-500 transition-all duration-400 dark:shadow-[0px_0px_10px_5px_rgba(255,255,255,0.1)] shadow-[0px_0px_10px_5px_rgba(0,0,0,0.1)]'>{copyState}</button>
        </div>
